...
class ViewController: UIViewController {
                ...
                case .success(let data):
                    if let uwStatusCode = status{
                        ...
                        case 200...299:
                            ...
                            do{
                                let receivedData =
                                try decoder.decode(ContactNames.self, from: data)
    ...
    func parseAndShowContactDetails(data: Data) {
        ...
        ////                let contact = ContactName(name: name, email: email, phone: phone)
        //                let contact = ContactName(name: name)
        //                
